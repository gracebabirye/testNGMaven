...
public class TestNgMavenSecondClass {
    ...
    public void checkLogin()
    {
          ...
          driver.findElement(By.xpath("//input[@name='email']")).sendKeys("grycbabie@gmail.com");
    ...
    public void screenShot() throws IOException
    {
        ...
        FileUtils.copyFile(file1, new File("C:\\Users\\CPL\\.jenkins\\workspace\\QAPractise\\test-output\\test1.PNG"));
